    ...
    <View style={styles.body}>
      <LinearGradient colors={['black', '#650010', 'black']} style={styles.gradient}>
        ...
        <View> 
          ...
          <Text style={styles.bodyTextTitle}>Tinto</Text>
          <Text style={styles.bodyText}>
            O vinho tinto é uma experiência sensorial inigualável, com sua rica
            cor, aroma envolvente e sabor complexo.
          </Text>
        </View>
        <View style={styles.alignImg}>
        <Pressable onPress={() => {navegar.navigate("Branco")}} title="Ir para a Tela 2" >
          <Image
            style={styles.imgTinto}
            source={require('./assets/Imagens/tinto-wallpaper.png')}
          />
          </Pressable>
        </View>
...
function TintoInicio({navigation}) {
  navegar = navigation;
  return (
