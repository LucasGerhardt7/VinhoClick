...
function Body() {
  return (
    <View style={styles.body}>
      <LinearGradient colors={['black', '#650010', 'black']} style={styles.gradient}>
       
        <View> 

          <Text style={styles.bodyTextTitle}>Rose</Text>
          <Text style={styles.bodyText}>
            O vinho rosé é um convite à jovialidade e à alegria. Com sua tonalidade delicada e seus aromas frutados, ele captura a essência do verão em cada gole.
          </Text>
        </View>
        <View style={styles.alignImg}>
          <Pressable onPress={() => {navegar.navigate("Tinto")}} title="Ir para a Tela 2" >
          <Image
            style={styles.imgTinto}
            source={require('./assets/Imagens/rose-wallpaper.png')}
          />
          </Pressable>
        </View>
...
function RoseInicio({navigation}) {
  navegar = navigation;
  return (
